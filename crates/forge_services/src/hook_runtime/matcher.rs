...
mod tests {
    ...
    fn test_condition_bash_git_rejects_other_commands() {
        ...
        assert_eq!(matches_condition("Bash(git *)", "Bash", &input), false);
    }
    ...
    fn test_condition_read_ts_rejects_other_extensions() {
        ...
        assert_eq!(matches_condition("Read(*.ts)", "Read", &input), false);
    }
    ...
    fn test_condition_rejects_when_tool_name_differs() {
        let input = json!({"command": "git status"});
        assert_eq!(matches_condition("Bash(git *)", "Write", &input), false);
    }
}
